                  ...
                  <div className="card card-shadow">
                    <div className="card-block text-xs-center bg-white p-40">
                      ...
                      <ul className="list-inline font-size-18 m-b-35">
                        ...
                        <Link to="/company/profile/"> <button type="button" className="btn btn-primary p-x-40">Modifier</button>   </Link>
                    </div>
                  </div>
                </div>
                          ...
                          <div className="panel" id="followers">
                            ...
                            <div className="panel-body">
                              <ul className="list-group list-group-dividered list-group-full h-250" data-plugin="scrollable">
                                ...
                                <Link to="/collaborators/"> <button type="button" className="btn btn-block btn-primary"> Ajouter </button> </Link>
